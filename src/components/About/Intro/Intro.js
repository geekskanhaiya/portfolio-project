            ...
            >
              <div className={`text-center ${styles.aboutText}`}>
                <div className="h3 mb-3 about-text">
                  I am <span className="orange_text">Kanhaiya</span> Kumar.
                </div>
                <div>
                  <span id="element-1">
                    I'm a final year Computer Science student at Meghnad
                    Saha Insititute Of Technology in Kolkata, West Bengal. I have
                    experience in forntend developer and learning full stack develoer. I am passionate about
                    coding, with expertise in C, C++, have solving
                    Leetcode problems. Beyond tech, I'm a playing cricket and listining music
                   🎓💻🏏🎶
                  </span>
                </div>
              </div>
